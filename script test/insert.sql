...
insert into sectors value(1, 12000, 'montagneux', 3, 1, 1);

insert into ways value(1, 'terrain accidenté longant le mont du ciel bleu', 6, 2000, 1),
					  (2, 'piste remontant le pic de l éffroi', 8, 1500, 1),
					  (3, 'chemin longant le lac des monts', 3, 8500, 1);
